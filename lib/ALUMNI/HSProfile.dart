...
class HSProfile extends StatefulWidget {
  ...
  @override
  HSProfileState createState() => HSProfileState();
}

class HSProfileState extends State<HSProfile> {
  ...
  TextEditingController degNameController = TextEditingController();
  TextEditingController majController = TextEditingController();
  ...
  Future<String> _uploadFile(dynamic file,String foldername, String fileName) async {
    Reference storageReference = FirebaseStorage.instance.ref().child('ALUMNI/WP/$foldername/$fileName');
    if (file is String) {
...
//                                 Reference referenceDirImages = referenceRoot.child('ALUMNI').child('WP').child('images');
...
//                             ),
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              onPressed: () async{
                                String eventId = await _addHSDetails(
                                    degNameController.text,
                                    majController.text,
                                    uniController.text ,
                                   locController.text,
                                ...
                                print(eventId);
                                _showSuccessSnackBar('Details Added Successfully!!');
                                Navigator.pop(context);
