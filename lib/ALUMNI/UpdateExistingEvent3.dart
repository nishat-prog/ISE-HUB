...
class UpdateExisitingEvent3 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: SingleChildScrollView(
          child:UpdateExisitingEvent(),
        )
    );
  }
}

class UpdateExisitingEvent extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            ...
                            // Navigate to the appropriate update page
                              ...
                              Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder: (context) => UpdateWP(
                                    eventDetails: EventDetails2(
                                      eventId: event['eventId'],
                                      cName: event['companyName'],
                                      desgn: event['designation'],
                                      exp: event['experience'],
                                      dept: event['department'],
                                      loc: event['location'],
                                      qlf:event['qualification'],
                                      skill: event['skills'],
