...
class UpdateHS extends StatefulWidget {
  final EventDetails1 eventDetails;

  UpdateHS({required this.eventDetails});

  @override
  _UpdateHSState createState() => _UpdateHSState();
}

class _UpdateHSState extends State<UpdateHS> {
  ...
  TextEditingController _degNameController = TextEditingController();
  TextEditingController _majController = TextEditingController();
  TextEditingController _uniController = TextEditingController();
  ...
  void initState() {
    ...
    _degNameController.text = widget.eventDetails.degName;
    _majController.text = widget.eventDetails.maj;
    _uniController.text = widget.eventDetails.uni;
    _locController.text = widget.eventDetails.loc;
    _gradeController.text = widget.eventDetails.grade;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Update Higher studies details",style: TextStyle(color:Colors.white),),
              ...
              child:SizedBox(
                ...
                child:ElevatedButton(
                  ...
                  onPressed: () async{
                    ...
                    await _databaseService.updateHS(
                      userId,
                      widget.eventDetails.eventId,
                      _degNameController.text,
                      _majController.text,
                      _uniController.text,
                      _locController.text,
