...
class WPProfile extends StatefulWidget {
  const WPProfile({Key? key}) : super(key: key);
  @override
  WPProfileState createState() => WPProfileState();
}

class WPProfileState extends State<WPProfile> {
  ...
  //   Reference storageReference = FirebaseStorage.instance.ref().child('ALUMNI/HS/$foldername/$fileName');
  //   if (file is String) {
...
//                                 Reference referenceDirImages = referenceRoot.child('ALUMNI').child('HS').child('images');
...
//                             ),
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              onPressed: () async{
                                String eventId = await _addWPDetails(
