...
class DeleteEvent2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(child:DeleteEventPage2(),),
    );
  }
}
String userId = FirebaseAuth.instance.currentUser?.uid ?? 'defaultUserId';
class DeleteEventPage2 extends StatelessWidget {
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            ...
                            FirebaseFirestore.instance
                                .collection(sectionTitle == 'FDP' ? 'faculty_development_programs' : 'journal_papers')
                                .doc(userId)
                                .collection(sectionTitle == 'FDP' ? 'programs' : 'papers')
