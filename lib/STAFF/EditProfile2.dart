...
class ProfileEditScreen2 extends StatefulWidget {
  final Profile2 initialProfile;


  ProfileEditScreen2({required this.initialProfile, Key? key}) : super(key: key);

  @override
  _ProfileEditScreen2State createState() => _ProfileEditScreen2State();
}

class _ProfileEditScreen2State extends State<ProfileEditScreen2> {
  String imageUrl='';
  ...
  Future<void> _updateUserProfile() async {
    ...
    try {
      ...
      await _databaseService.updateStaffProfile(
          userId,
          name,
          usn,
          phone,
            ...
            children: [
              ...
              CupertinoButton(
                onPressed: () async {
                  ...
                  Reference referenceDirImages = referenceRoot.child('STAFF').child('profile_photos');
