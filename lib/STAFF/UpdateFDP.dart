...
class UpdateFDP extends StatefulWidget {
  final EventDetails1 eventDetails;

  UpdateFDP({required this.eventDetails});

  @override
  _UpdateFDPState createState() => _UpdateFDPState();
}

class _UpdateFDPState extends State<UpdateFDP> {
