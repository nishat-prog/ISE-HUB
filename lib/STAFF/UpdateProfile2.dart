...
class UpdateProfile2 extends StatefulWidget {
  const UpdateProfile2({Key? key}) : super(key: key);
              ...
              children: [
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).pushNamed('AddEvent2');
                    },
                    child: Text(
                      "Add an event",
                      style: TextStyle(
                ...
                Center(
                  child: Container(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.of(context).pushNamed('UpdateExistingEvent2');
                      },
                      child: Text(
                ...
                Center(
                  child: Container(
                    ...
                    child: ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.of(context).pushNamed('DeleteEvent2');
                      },
                      child: Text(
                        "Delete an event",
                        style: TextStyle(
