...
class ExtraCurricularProfile extends StatefulWidget {
  const ExtraCurricularProfile({Key? key}) : super(key: key);
  @override
  ExtraCurricularProfileState createState() => ExtraCurricularProfileState();
}

class ExtraCurricularProfileState extends State<ExtraCurricularProfile> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Extra-Curricular Events",
            style:TextStyle(
                color:Colors.white,
                fontWeight: FontWeight.bold
            )),
