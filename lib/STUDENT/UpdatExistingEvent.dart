...
import 'UpdateExtraCurricularEvent.dart';

class UpdateEventListPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: SingleChildScrollView(
          child:UpdateEventList(),
        )
    );
  }
}

class UpdateEventList extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
      ...
      print(sectionTitle);
                          ...
                          if (sectionTitle == 'Academic Events') {
                            ...
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (context) => UpdateAcademicEventPage(
                          ...
                          } else if (sectionTitle == 'Extra-Curricular Events') {
                            Navigator.of(context).push(
                              MaterialPageRoute(
                                builder: (context) => UpdateExtraCurricularEventPage(
