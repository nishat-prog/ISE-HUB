...
class UpdateAcademicEventPage extends StatefulWidget {
  final EventDetails eventDetails;

  UpdateAcademicEventPage({required this.eventDetails});

  @override
  _UpdateAcademicEventPageState createState() => _UpdateAcademicEventPageState();
}

class _UpdateAcademicEventPageState extends State<UpdateAcademicEventPage> {
  ...
  void initState() {
    ...
    _aicteController.text = widget.eventDetails.aicte;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Update Academic Event"),
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height:20),
            TextFormField(
              controller: _aicteController,
              enabled: false,
              decoration: InputDecoration(labelText: 'Aicte points'),
            ),
            SizedBox(height:20),
            TextFormField(
              ...
              child:SizedBox(
                ...
                child:ElevatedButton(
                  ...
                  onPressed: () async{
                    ...
                    await _databaseService.updateAcademicEvent(
                      userId,
