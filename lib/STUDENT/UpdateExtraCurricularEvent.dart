...
class UpdateExtraCurricularEventPage extends StatefulWidget {
  final EventDetails2 eventDetails;

  UpdateExtraCurricularEventPage({required this.eventDetails});

  @override
  _UpdateExtraCurricularEventPageState createState() => _UpdateExtraCurricularEventPageState();
}

class _UpdateExtraCurricularEventPageState extends State<UpdateExtraCurricularEventPage> {
  ...
  Future<String> _uploadFile(dynamic file,String foldername, String fileName) async {
    Reference storageReference = FirebaseStorage.instance.ref().child('STUDENT/ExtraCurricular/$foldername/$fileName');
    if (file is String) {
          ...
          children: [
            ...
            GestureDetector(
              onTap: () async {
                ...
                Reference referenceDirImages = referenceRoot.child('STUDENT').child('ExtraCurricular').child("images");
