...
import 'DocumentDisplayPage.dart';
...
class _StudentRecordsScreenState extends State<StudentRecordsScreen> {
  ...
  Widget buildMonthStreamBuilder(int year, int month) {
    // CollectionReference academicEventsCollection = FirebaseFirestore.instance.collection('academic_event_details');
    // Query academicEventsQuery = academicEventsCollection.where('year', isEqualTo: year).where('month', isEqualTo: month);
    return StreamBuilder<QuerySnapshot>(
     // stream: academicEventsQuery.snapshots(),
      ...
      builder: (context, academicSnapshot) {
        if (academicSnapshot.connectionState == ConnectionState.waiting) {
          ...
          // CollectionReference extracurricularEventsCollection = FirebaseFirestore.instance.collection('academic_event_details');
          // Query extracurricularEventsQuery = extracurricularEventsCollection.where('year', isEqualTo: year).where('month', isEqualTo: month);
          return StreamBuilder<QuerySnapshot>(
          //  stream: extracurricularEventsQuery.snapshots(),
            stream: FirebaseFirestore.instance.collection('extracurricular_event_details').doc(userId).collection('events')
                .where('year', isEqualTo: year)
                .where('month', isEqualTo: month)
                .snapshots(),
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      StreamBuilder<QuerySnapshot>(
                        stream: FirebaseFirestore.instance.collection('student_account_information')
                            .snapshots(),
          ...
          return StreamBuilder<QuerySnapshot>(
            ...
            builder: (context, extracurricularSnapshot) {
              if (extracurricularSnapshot.hasData) {
                ...
                return _buildEventSection('AcademicEvents', userId, userName,
